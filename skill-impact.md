...
- F0 final lfm (10 células): CONF corroboram = brew-zeemu, infuse-status, zeeno-status, abi-eventos, sdk-headers. INCERTO = loader-zeebulator, brew-zeebulator (genéricas), oem-zwheel + ggz-formato (fora do tópico), runtime-brew (vaga). Regra: lfm fiel a lista/valor literal no chunk; síntese livre = conferir ou descartar.
